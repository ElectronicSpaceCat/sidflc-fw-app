...
:: Firmware location
SET FW=..\%PROJ_NAME%-fw-app\build\%PROJ_NAME%_fw_app.hex

:: Bootloader location
SET BL=..\%PROJ_NAME%-fw-bootloader\build\%PROJ_NAME%_fw_bootloader.hex

:: Output file name
SET OUTPUT_NAME=%PROJ_NAME%_fw_app_prod
